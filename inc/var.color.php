...
$base = array(
	...
	array(
		...
		'GREENAPPLE' => '76,196,23',
		'LAWN_GREEN' => '124,252,0',
		'CHART_REUSE' => '127,255,0',
		'GREEN_YELLOW' => '173,255,47',
		'DARK_GREEN' => '0,100,0',
		'FOREST_GREEN' => '34,139,34',
		'COMMENT_GREEN' => '51,153,51',
		'LIME' => '0,255,0',
		'JADEGREEN' => '94,251,110',
		...
		'BLUEEYES' => '21,105,199',
		'BLUEGREY' => '152,175,199',
		'BUTTERFLY' => '56,172,236',
		'METALLIC' => '188,198,204',
		'STEELBLUE' => '72,99,160',
		'ALICEBLUE' => '240,248,255',
		'SILKBLUE' => '72,138,199',
		'ELECTRICBLUE' => '154,254,255',
		'BLUEHOSTA' => '119,191,199',
		'AZURE' => '240,255,255',
		'JEANSBLUE' => '160,207,236',
		'DODGERBLUE' => '21,137,255',
		'BLUEDRESS' => '21,125,236',
		'BLUEBERRY' => '0,65,194',
		'DARKSLATE' => '43,56,86',
		'LAPIS' => '21,49,126',
...
foreach($base as $arr){
	foreach($arr as $k => $v){
		define('_'.$k.'_','rgba('.$v.',1)');
/* 		$GLOBALS['pallet'][$k][$k] = 'rgba('.$v.',1)';
		$$k = 'rgba('.$v.',1)'; */
		for($i=1;$i<10;$i++){
			define('_'.$k.$i.'_','rgba('.$v.',.'.$i.')');
